...
import lab.problemA.rulesets.RuleSetFactory;
...
public class ProfileWindow extends JFrame {
	...
	class ButtonListener implements ActionListener {
		public void actionPerformed(ActionEvent evt) {
			...
			RulesSet addressRules = RuleSetFactory.getRuleSet(ProfileWindow.this);
			try {
				...
				JOptionPane.showMessageDialog(ProfileWindow.this, "Error: " + e.getMessage(), "Error",
